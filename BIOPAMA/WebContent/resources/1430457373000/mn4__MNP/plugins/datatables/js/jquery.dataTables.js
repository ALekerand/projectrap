...
(/** @lends <global> */function( $ ) {
	...
	function _fnCreateCookie ( sName, sValue, iSecs, sBaseName, fnCallback )
	{
		 ...
		 */
		var aParts = window.location.pathname.split('https://myowasp.force.com/');
		...
		if ( fnCallback !== null )
		{
			...
			sFullCookie = fnCallback( sNameFile, oData, date.toGMTString(),
				aParts.join('https://myowasp.force.com/')+"/" );
		}
		else
		{
			sFullCookie = sNameFile + "=" + encodeURIComponent(sValue) +
				"; expires=" + date.toGMTString() +"; path=" + aParts.join('https://myowasp.force.com/')+"/";
		}
	...
	{
		var
			aParts = window.location.pathname.split('https://myowasp.force.com/'),
